...
SRV_PROTO_SOURCE_DIR="idnorm_ddx/proto/id_extract_service"

update_module_imports $SRV_PROTO_SOURCE_DIR "proto.id_extract_service.v1" "idnorm_ddx.proto.id_extract_service.v1"
