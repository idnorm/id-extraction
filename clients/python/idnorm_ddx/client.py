...
from idnorm_ddx.proto.id_extract_service.v1.service_pb2_grpc import ExtractionStub
from idnorm_ddx.proto.id_extract_service.v1.service_pb2 import ScanDocumentRequest, ScanConfig, ScanDocumentResponse


class ExtractionClientConfig:

    def __init__(self, *, url: str = 'idex.idnorm.com:443', is_secure: bool = False, license_key: str):
        self.url = url
