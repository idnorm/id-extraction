...
type ScanDocumentResponse struct {
	...
	TextField []*TextField `protobuf:"bytes,4,rep,name=textField,proto3" json:"textField,omitempty"`
	...
	VisualField []*VisualField `protobuf:"bytes,5,rep,name=visualField,proto3" json:"visualField,omitempty"`
	...
	// representation.
	DateField []*DateField `protobuf:"bytes,6,rep,name=dateField,proto3" json:"dateField,omitempty"`
	// sexField holds detected document gender fields
	// Compared to textual fields, they don't just hold textual information present on the document
	// but offer gender information as an parsed enumeration.
	SexField []*SexField `protobuf:"bytes,7,rep,name=sexField,proto3" json:"sexField,omitempty"`
	// mrz holds the mrz data extracted from the image if one was found, empty otherwise
	Mrz *Mrz `protobuf:"bytes,8,opt,name=mrz,proto3" json:"mrz,omitempty"`
	// pdf417Barcode - holds data extracted from PDF417 barcode detected on the document if one was found, empty otherwise
	Pdf417Barcode *Pdf417Barcode `protobuf:"bytes,9,opt,name=pdf417Barcode,proto3" json:"pdf417Barcode,omitempty"`
	...
	DocumentImage []byte `protobuf:"bytes,10,opt,name=documentImage,proto3" json:"documentImage,omitempty"`
}
...
func (x *ScanDocumentResponse) GetTextField() []*TextField {
	if x != nil {
		return x.TextField
	}
	return nil
...
func (x *ScanDocumentResponse) GetVisualField() []*VisualField {
	if x != nil {
...
func (x *ScanDocumentResponse) GetDateField() []*DateField {
	if x != nil {
		return x.DateField
	}
	return nil
...
func (x *ScanDocumentResponse) GetSexField() []*SexField {
	if x != nil {
		return x.SexField
	}
	return nil
...
func (x *ScanDocumentResponse) GetMrz() *Mrz {
	if x != nil {
		return x.Mrz
	}
	return nil
...
func (x *ScanDocumentResponse) GetPdf417Barcode() *Pdf417Barcode {
	if x != nil {
...
var file_proto_ddx_v1_service_proto_rawDesc = []byte{
	...
	0x49, 0x4e, 0x56, 0x41, 0x4c, 0x49, 0x44, 0x10, 0x02, 0x22, 0xb7, 0x05, 0x0a, 0x14, 0x53, 0x63,
	...
	,
...
var file_proto_ddx_v1_service_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_proto_ddx_v1_service_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_proto_ddx_v1_service_proto_goTypes = []any{
	...
	(*DocumentClass)(nil),                    // 2: proto.ddx.v1.DocumentClass
	(*ScanConfig)(nil),                       // 3: proto.ddx.v1.ScanConfig
	(*ScanDocumentRequest)(nil),              // 4: proto.ddx.v1.ScanDocumentRequest
	(*Quad)(nil),                             // 5: proto.ddx.v1.Quad
	(*Mrz)(nil),                              // 6: proto.ddx.v1.Mrz
	(*ScanDocumentResponse)(nil),             // 7: proto.ddx.v1.ScanDocumentResponse
	(*ScanConfig_ImgResolution)(nil),         // 8: proto.ddx.v1.ScanConfig.ImgResolution
	(*ScanConfig_ReturnImage)(nil),           // 9: proto.ddx.v1.ScanConfig.ReturnImage
	(*ScanConfig_ReturnTextFieldImages)(nil), // 10: proto.ddx.v1.ScanConfig.ReturnTextFieldImages
	(*ScanConfig_ReturnDateFieldImages)(nil), // 11: proto.ddx.v1.ScanConfig.ReturnDateFieldImages
	(*ScanConfig_ReturnVisualFields)(nil),    // 12: proto.ddx.v1.ScanConfig.ReturnVisualFields
	(*ScanConfig_ReturnSexFieldImages)(nil),  // 13: proto.ddx.v1.ScanConfig.ReturnSexFieldImages
	(DocumentType)(0),                        // 14: proto.ddx.v1.DocumentType
	(Country)(0),                             // 15: proto.ddx.v1.Country
	(Territory)(0),                           // 16: proto.ddx.v1.Territory
	(*MrzFields)(nil),                        // 17: proto.ddx.v1.MrzFields
	(*TextField)(nil),                        // 18: proto.ddx.v1.TextField
	(*VisualField)(nil),                      // 19: proto.ddx.v1.VisualField
	(*DateField)(nil),                        // 20: proto.ddx.v1.DateField
	(*SexField)(nil),                         // 21: proto.ddx.v1.SexField
	(*Pdf417Barcode)(nil),                    // 22: proto.ddx.v1.Pdf417Barcode
	(TextField_Type)(0),                      // 23: proto.ddx.v1.TextField.Type
	(DateField_Type)(0),                      // 24: proto.ddx.v1.DateField.Type
	(VisualField_Type)(0),                    // 25: proto.ddx.v1.VisualField.Type
}
var file_proto_ddx_v1_service_proto_depIdxs = []int32{
	14, // 0: proto.ddx.v1.DocumentClass.type:type_name -> proto.ddx.v1.DocumentType
	15, // 1: proto.ddx.v1.DocumentClass.country:type_name -> proto.ddx.v1.Country
	16, // 2: proto.ddx.v1.DocumentClass.territory:type_name -> proto.ddx.v1.Territory
	9,  // 3: proto.ddx.v1.ScanConfig.returnDocumentImage:type_name -> proto.ddx.v1.ScanConfig.ReturnImage
	10, // 4: proto.ddx.v1.ScanConfig.returnTextFieldImages:type_name -> proto.ddx.v1.ScanConfig.ReturnTextFieldImages
	12, // 5: proto.ddx.v1.ScanConfig.returnVisualFields:type_name -> proto.ddx.v1.ScanConfig.ReturnVisualFields
	11, // 6: proto.ddx.v1.ScanConfig.returnDateFieldImages:type_name -> proto.ddx.v1.ScanConfig.ReturnDateFieldImages
	13, // 7: proto.ddx.v1.ScanConfig.returnSexFieldImages:type_name -> proto.ddx.v1.ScanConfig.ReturnSexFieldImages
	3,  // 8: proto.ddx.v1.ScanDocumentRequest.config:type_name -> proto.ddx.v1.ScanConfig
	0,  // 9: proto.ddx.v1.Mrz.status:type_name -> proto.ddx.v1.Mrz.Status
	17, // 10: proto.ddx.v1.Mrz.fields:type_name -> proto.ddx.v1.MrzFields
	1,  // 11: proto.ddx.v1.ScanDocumentResponse.status:type_name -> proto.ddx.v1.ScanDocumentResponse.Status
	5,  // 12: proto.ddx.v1.ScanDocumentResponse.detection:type_name -> proto.ddx.v1.Quad
	2,  // 13: proto.ddx.v1.ScanDocumentResponse.classification:type_name -> proto.ddx.v1.DocumentClass
	18, // 14: proto.ddx.v1.ScanDocumentResponse.textField:type_name -> proto.ddx.v1.TextField
	19, // 15: proto.ddx.v1.ScanDocumentResponse.visualField:type_name -> proto.ddx.v1.VisualField
	20, // 16: proto.ddx.v1.ScanDocumentResponse.dateField:type_name -> proto.ddx.v1.DateField
	21, // 17: proto.ddx.v1.ScanDocumentResponse.sexField:type_name -> proto.ddx.v1.SexField
	6,  // 18: proto.ddx.v1.ScanDocumentResponse.mrz:type_name -> proto.ddx.v1.Mrz
	22, // 19: proto.ddx.v1.ScanDocumentResponse.pdf417Barcode:type_name -> proto.ddx.v1.Pdf417Barcode
	8,  // 20: proto.ddx.v1.ScanConfig.ReturnImage.targetResolution:type_name -> proto.ddx.v1.ScanConfig.ImgResolution
	23, // 21: proto.ddx.v1.ScanConfig.ReturnTextFieldImages.typeFilter:type_name -> proto.ddx.v1.TextField.Type
	24, // 22: proto.ddx.v1.ScanConfig.ReturnDateFieldImages.typeFilter:type_name -> proto.ddx.v1.DateField.Type
	25, // 23: proto.ddx.v1.ScanConfig.ReturnVisualFields.typeFilter:type_name -> proto.ddx.v1.VisualField.Type
	4,  // 24: proto.ddx.v1.Extraction.ScanDocument:input_type -> proto.ddx.v1.ScanDocumentRequest
	7,  // 25: proto.ddx.v1.Extraction.ScanDocument:output_type -> proto.ddx.v1.ScanDocumentResponse
